            ...
            <div class="col-md-12">        
                <div class="row">
                    <div class="aa-banner-area">
                        <a href="#"><img src="${url}/images/banner-gg.jpg" alt="banner trang chủ"></a>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <ul class="aa-testimonial-slider">
                        ...
                        <li>
                            <div class="aa-testimonial-single">
                                <img class="aa-testimonial-img" src="${url}/images/avatar-hung.jpg" alt="avatar 1">
                        ...
                        <li>
                            <div class="aa-testimonial-single">
                                <img class="aa-testimonial-img" src="${url}/images/avatar-trung.jpg" alt="avatar 2">
                                <span class="fa fa-quote-left aa-testimonial-quote"></span>
                                <p> Về chất lượng của sản phẩm thì khỏi phải bàn, tất cả các sản phẩm đều được thiết kế nhỏ gọn và đẹp mắt. Tôi sẽ mua hàng ở đây thường xuyên<p>
                                <div class="aa-testimonial-info">
                                    <p>Khắc Trung</p>
                        ...
                        <li>
                            <div class="aa-testimonial-single">
                                <img class="aa-testimonial-img" src="${url}/images/avatar-anh.jpg" alt="avatar 3">
                                <span class="fa fa-quote-left aa-testimonial-quote"></span>
                                <p>Tôi đã mua hàng ở đây nhiều lần, chất lượng sản phẩm ở đây thì rất là tuyệt vời, đặc biệt là giá cá hợp lý, thường xuyên có các đợt khuyến mãi lớn!</p>
                                <div class="aa-testimonial-info">
                                    <p>Văn Anh</p>
                                    <span>Nhân Viên Dọn Vệ Sinh</span>
                                </div>
                            </div>
                        </li>
                    </ul>
